<x-app-layout>
    <div class="py-12" style="animation: rotate-fade 0.5s ease-in-out;">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8     mb-10 flex justify-between items-center">
            <div>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 flex flex-col">
            ...
            <div class="bg-white  shadow-md rounded-xl">
                <header class="px-5 py-4   flex justify-between items-center">
                    ...
                    <div id="popup-modal-delete-all" tabindex="-1" class="fixed top-0 bg-opacity-50 left-0 right-0 z-50 hidden p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
                        <div class="relative w-full max-w-md max-h-full">
                            <div class="relative bg-white rounded-lg shadow">
                                <button type="button" class="absolute top-3 right-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ml-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-hide="popup-modal-delete-all">
                                ...
                                <div class="p-6 text-center">
                                    ...
                                    <div class="flex items-center justify-between">
                                        ...
                                        <button data-modal-hide="popup-modal-delete-all" type="button" class="text-gray-500 bg-white hover:bg-gray-700 hover:text-white focus:ring-4 focus:outline-none focus:ring-gray-200 rounded-lg border border-gray-200 text-sm font-medium px-5 py-2.5 hover:text-gray-900 focus:z-10">Annulla</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="overflow-x-auto">
                        <div class="flex flex-wrap justify-center md:justify-start">
                            ...
                            <div class="relative group">
                                <div class="  cursor-pointer " data-modal-target="popup-modal-show-{{ $file->id }}" data-modal-toggle="popup-modal-show-{{ $file->id }}">
                                    <figure class="  transition overflow-hidden">
                                        <img style="width: 180px; height:180px; object-fit: cover; object-position: center" class=" rounded-2xl border m-1  transition-transform group-hover:scale-95" src="{{ asset('storage/'. $file->img_url) }}" alt="{{ $file->name }}">
                                    </figure>
                                </div>
                                <form action="{{ route('admin.files.downloadFile', $file->id) }}" method="post" class="absolute right-5 hidden top-5 group-hover:block ">
                                    @csrf
                                ...
                                {{-- modal elimina uno --}}
                                <div id="popup-modal-delete-{{ $file->id }}" tabindex="-1" class="fixed p-5 top-0 bg-opacity-50 left-0 right-0 z-50 hidden overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
                                    <div class="relative w-full max-w-md max-h-full">
                                        <div class="relative bg-white rounded-lg shadow">
                                ...
                                {{-- SHOW --}}
                                <div id="popup-modal-show-{{ $file->id }}" tabindex="-1" class="fixed p-5 top-0 left-0 right-0 z-50 hidden bg-opacity-50  overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
                                    <div class="relative">
                                        <div class="relative bg-white rounded-lg shadow">
                                            ...
                                            <div class="p-6 text-center">
                                                <div class="flex items-center justify-between">
                                                    <figure class="w-[500px] h-[500px]">
                                                        <img src="{{ asset('storage/'. $file->img_url) }}" class="w-full h-full object-contain" alt="{{ $file->name }}">
                                                    </figure>
                                                </div>
                                            </div>
                                        </div>
